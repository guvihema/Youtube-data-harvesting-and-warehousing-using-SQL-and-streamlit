...
loaded_model = joblib.load('F:\\Guvi Projects\\Car_Dheko_Project\\Models\\rf_trainedmodel.pkl')
loaded_encoders = joblib.load('F:\\Guvi Projects\\Car_Dheko_Project\\Models\\label_encoders.pkl')
loaded_scaler = joblib.load('F:\\Guvi Projects\\Car_Dheko_Project\\Models\\min.pkl')
ridge_model = joblib.load('F:\\Guvi Projects\\Car_Dheko_Project\\Models\\ridge_model.pkl')
